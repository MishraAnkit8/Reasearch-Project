...
module.exports.insertPatentData = async(patentData,file) => {
    ...
    let sql = {
        text : `INSERT INTO  patent_submissions (type_of_invention, title_of_invention,  patent_stage, achive_sdg, application_no, date,        is_presenter, myfile) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING id`,
